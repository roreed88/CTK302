...
//fonts
    font1 = loadFont('assets/technoF.ttf');
...
function draw() {
  ...
  switch (myState) {
    case 0:
      ...
      textSize(40);
      textAlign(CENTER);
      text("Catch the Robots with Bounce Back!", width/2, height/1.75, windowWidth - 200, windowHeight - 200);

      fill(0, 187, 249);
      rect(width/2, height/2.5, 50, 80, 10);

      fill(255, 147, 31);
      textFont(font1);
      textSize(30);
      textAlign(CENTER);
      text("START!", width/2, height/2.5, windowWidth - 200, windowHeight - 200);
